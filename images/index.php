...
<body>
    <div class="">
        ...
        <h1>
					Welcome to the <span class="blue">Siyam Raza</span> on Bluemix!
				</h1>
...
<input type="button" class = "mybutton" onclick="window.location = 'mainkaam/index.html';" class="btn" value="(Re-)Create table"></input>
                </td> 
            </form>
        </tr>
        </tbody>
